        ...
        <div className={styles.frameParent4}>
          ...
          <div className={styles.frameParent9}>
            <div className={styles.downParent1}>
              ...
              <div className={styles.dNParent}>
                <div className={styles.toDN}>Cần làm</div>
                <div className={styles.wrapper}>
                  <div className={styles.toDN}>03</div>
                </div>
              </div>
            </div>
                ...
                >
                  <div className={styles.input1}>
                    ...
                    <div className={styles.label4}>
                      ...
                      <span className={styles.vAnh}>Vũ Anh</span>
                    </div>
                    <img
                      className={styles.outlineSearch}
                      alt=""
          ...
          <div className={styles.frameParent10}>
            <div className={styles.downParent1}>
              <img className={styles.downIcon} alt="" src="/down.svg" />
              <div className={styles.dNParent}>
                <div className={styles.toDN}>Đang làm</div>
          ...
          <div className={styles.frameParent11}>
            <div className={styles.downParent1}>
              <img className={styles.downIcon} alt="" src="/down.svg" />
              <div className={styles.dNParent}>
                <div className={styles.toDN}>Review</div>
                <div className={styles.number1}>
                  <div className={styles.toDN}>03</div>
                </div>
          ...
          <div className={styles.frameParent9}>
            <div className={styles.downParent1}>
              ...
              <div className={styles.dNParent}>
                <div className={styles.toDN}>Quá hạn</div>
                <div className={styles.wrapper}>
                  <div className={styles.toDN}>02</div>
                </div>
                <div className={styles.statistical1} />
                <div className={styles.statistical1} />
                <div className={styles.statistical1} />
